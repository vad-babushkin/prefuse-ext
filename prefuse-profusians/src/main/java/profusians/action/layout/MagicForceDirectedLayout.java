...
/**
 * A modification of the ForceDirectedLayout of the prefuse library, which
 * allows to declare all edges and/or nodes magic. The forces of magic
 * nodes/edges are still computed even if the nodes/edges is invisible.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net"> martin dudek</a>
 * 
 */
public class MagicForceDirectedLayout extends Layout {
    ...
    /**
         * Create a new ForceDirectedLayoutMagic. By default, this layout will
         * not restrict the layout to the layout bounds and will assume it is
         * being run in animated (rather than run-once) fashion.
         * 
         * @param graph
         *                the data group to layout. Must resolve to a Graph
         *                instance.
         */
    public MagicForceDirectedLayout( String graph) {
	this(graph, false, false);
    }

    /**
         * Create a new ForceDirectedLayoutMagic. The layout will assume it is
         * being run in animated (rather than run-once) fashion.
         * 
         * @param group
         *                the data group to layout. Must resolve to a Graph
         ...
         *                that all node placements stay within the layout
         *                bounds.
         */
    public MagicForceDirectedLayout( String group,
    ...
    /**
         ...
         *                animated fashion. In run-once mode, the layout will
         *                run for a set number of iterations when invoked. In
         *                animation mode, only one iteration of the layout is
         *                computed.
         */
    public MagicForceDirectedLayout( String group,
    ...
    /**
         ...
         *                instance.
         * @param fsim
         *                the force simulator used to drive the layout
         *                computation
         * @param enforceBounds
         *                indicates whether or not the layout should require
         *                that all node placements stay within the layout
    ...
    /**
         * Get the maximum timestep allowed for integrating node settings
         * between runs of this layout. When computation times are longer than
         * desired, and node positions are changing dramatically between
         * animated frames, the max step time can be lowered to suppress node
         * movement.
         * 
    ...
    /**
         * Set the maximum timestep allowed for integrating node settings
         * between runs of this layout. When computation times are longer than
         * desired, and node positions are changing dramatically between
         * animated frames, the max step time can be lowered to suppress node
         * movement.
         * 
         * @param maxstep
         *                the maximum timestep allowed for integrating between
         *                two layout steps
         */
    ...
    /**
         * Reset the force simulation state for all nodes processed by this
         * layout.
         */
    public void reset() {
	 Iterator iter = getMagicIterator(m_nodeGroup);
    ...
    /**
         * Get the spring length for the given edge. Subclasses should override
         * this method to perform custom spring length assignment.
         * 
         * @param e
    ...
    /**
         ...
         * tension or strength of the spring. Subclasses should override this
         * method to perform custom spring tension assignment.
         * 
         * @param e
         *                the edge for which to compute the spring coefficient.
         * @return the spring coefficient for the edge. A return value of -1
         *         means to ignore this method and use the global default.
         */
    ...
    /**
         * The data field in which the parameters used by this layout are
         * stored.
         */
