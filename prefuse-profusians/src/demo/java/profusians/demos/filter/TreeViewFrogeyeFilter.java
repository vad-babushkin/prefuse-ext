package profusians.demos.filter;
...
import profusians.action.filter.FrogeyeFilter;
import profusians.action.layout.FlexibleTreeRootCollapsedSubtreeLayout;
 ...
 */
public class TreeViewFrogeyeFilter extends Display {
    ...
    private static final int FROG_DISTANCE = 2;
    ...
    public TreeViewFrogeyeFilter(Tree t, String label) {
	...
	FlexibleTreeRootCollapsedSubtreeLayout subLayout = new FlexibleTreeRootCollapsedSubtreeLayout(
		tree, m_orientation);
	...
	final FrogeyeFilter frogfilter = new FrogeyeFilter(tree, FROG_DISTANCE);
	filter.add(frogfilter);
	...
	focusGroup.addTupleSetListener(new TupleSetListener() {
		...
		for (int i = 0; i < frogfilter.getPredecessorSphereDistance(); i++) { // TODO:
                                                                                        // should
                                                                                        // be
                                                                                        // offered
                                                                                        // by
	...
	FlexibleTreeRootCollapsedSubtreeLayout stl = (FlexibleTreeRootCollapsedSubtreeLayout) m_vis
		.getAction("subLayout");
	switch (orientation) {
	...
	JFrame frame = new JFrame(
		"p r e f u s e  |  s u b t r e e v i e w  -  f r o g e y e t r e e f i l t e r");
	...
	final TreeViewFrogeyeFilter tview = new TreeViewFrogeyeFilter(t, label);
