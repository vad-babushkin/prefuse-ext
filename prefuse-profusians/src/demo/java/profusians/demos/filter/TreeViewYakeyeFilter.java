...
import profusians.action.filter.YakeyeFilter;
...
public class TreeViewYakeyeFilter extends Display {
	...
	final YakeyeFilter yakfilter = new YakeyeFilter(tree, YAK_DISTANCE);
	...
	focusGroup.addTupleSetListener(new TupleSetListener() {
		...
		for (int i = 0; i < yakfilter.getPredecessorStepsDistance(); i++) {// TODO:
                                                                                        // should
                                                                                        // be
                                                                                        // offered
                                                                                        // by
	...
	JFrame frame = new JFrame(
		"p r e f u s e  |  s u b t r e e v i e w  -  y a k e y e t r e e f i l t e r");
