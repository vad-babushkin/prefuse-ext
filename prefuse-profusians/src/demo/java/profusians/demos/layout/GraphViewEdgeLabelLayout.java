...
import profusians.action.layout.EdgeLabelLayout;

/**
 * The prefuse GraphView demo with some additional edge rendering and
 * decorations Requires the file socialnetRelations.xml
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */
public class GraphViewEdgeLabelLayout extends JPanel {
    ...
    public GraphViewEdgeLabelLayout(Graph g, String label) {
	...
	/*
         * MAD - defining the decorator schema and adding the edge decorator
         * group to the visualization using the edge decorator schema
         */
	...
	// MAD - adding the edge label layout to the animate action
	animate.add(new EdgeLabelLayout(m_vis, drf, edges, "relation", ColorLib
		.rgba(100, 100, 100, 200), FontLib.getFont("Tahoma", 7)));
	...
	final GraphViewEdgeLabelLayout view = new GraphViewEdgeLabelLayout(g,
		label);

	// set up menu

	// launch window
	JFrame frame = new JFrame("p r o f u s e  |  EdgeLabelLayout");
	...
	private GraphViewEdgeLabelLayout m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewEdgeLabelLayout view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewEdgeLabelLayout view) {
	    m_view = view;
    ...
    /*
         * MAD - the layout for the edges which places the relation type in the
         * middle of the edge
         */
