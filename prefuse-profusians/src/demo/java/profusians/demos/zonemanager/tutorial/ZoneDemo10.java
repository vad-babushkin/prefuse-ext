...
import profusians.demos.zonemanager.tutorial.zonefactories.ZoneDemo10_ZoneFactory;
...
public class ZoneDemo10 extends Display {
	...
	catchThem.add(zoneManager.getZoneLayout());
	...
	zoneManager.setZoneFactory(new ZoneDemo10_ZoneFactory());

	zoneManager.addZonesFromFile("data/profusians/zones10.xml");
    ...
    public static JFrame demo(ZoneDemo10 sd) {

	JFrame frame = new JFrame(
		"z o n e m a n a g e r  d e m o  10  |  flexible nodes");
