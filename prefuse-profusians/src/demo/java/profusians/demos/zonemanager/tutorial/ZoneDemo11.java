...
/**
 * some zones - some nodes - some time
 * 
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */

public class ZoneDemo11 extends Display {
    ...
    public static JFrame demo(ZoneDemo11 sd) {

	JFrame frame = new JFrame(
		"z o n e m a n a g e r  d e m o  11  | some zones - some nodes - some time");
