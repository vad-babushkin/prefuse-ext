...
public class ZoneDemo09Modification extends Display {
	...
	ForceDirectedLayout fdlChaos = fdlZone;
	...
	zoneManager.setAllZonesActive(true);
	...
	ZoneDemo09Modification ad = new ZoneDemo09Modification();
    ...
    public static JFrame demo(ZoneDemo09Modification sd) {
	...
	ZoneDemo09Modification sd;

	public ZoneShow(ZoneDemo09Modification sd) {
	    super();
	    this.sd = sd;
	}
