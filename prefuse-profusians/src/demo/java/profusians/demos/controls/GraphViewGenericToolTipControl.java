 ...
 * which shows the usage of a GenericToolTipControl to display additional
...
public class GraphViewGenericToolTipControl extends JPanel {
    ...
    public GraphViewGenericToolTipControl(Graph g, String label) {
	...
	String tt[] = { "My precious name:", "My delightful gender: " };
	String ff[] = { "name", "gender" };

	GenericToolTipControl genericTTControl = new GenericToolTipControl(tt,
		ff, 100);

	display.addControlListener(genericTTControl);
	...
	overview.addControlListener(genericTTControl);
	...
	final GraphViewGenericToolTipControl view = new GraphViewGenericToolTipControl(
		g, label);
	...
	private GraphViewGenericToolTipControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewGenericToolTipControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewGenericToolTipControl view) {
	    m_view = view;
