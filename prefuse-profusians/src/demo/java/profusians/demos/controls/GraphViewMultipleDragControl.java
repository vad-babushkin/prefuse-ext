...
import profusians.controls.MultipleDragControl;

/**
 * Variation on the orignal GraphView, which implements a MultipleDragControl,
 * which drags all focused items around, if the ctrl key is pressed.
 * 
 * 
 * @author goose
 * 
...
public class GraphViewMultipleDragControl extends JPanel {
    ...
    public GraphViewMultipleDragControl(Graph g, String label) {
	...
	focusGroup.addTupleSetListener(new TupleSetListener() {
		...
		/*
                 * if ( ts.getTupleCount() == 0 ) { ts.addTuple(rem[0]);
	...
	display.addControlListener(new MultipleDragControl());
	...
	final GraphViewMultipleDragControl view = new GraphViewMultipleDragControl(
		g, label);
	...
	private GraphViewMultipleDragControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewMultipleDragControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewMultipleDragControl view) {
	    m_view = view;
