...
/**
 * This program demonstrates the usage of the
 * NeighborHighlightControlForDirectedGraphs class, an extensions of the
 * ControlAdapter class from the prefuse library. This control highlights source
 * neighbors, target neighbors and neighbors which are both in user defined
 * colors.
 * 
 * This demo needs the file socialnetDirected.xml to work. Search for the string
 * MAD (most amazing discovery) in order to find the changes from the original
 * GraphView source code.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */

public class GraphViewDirectedNeighborHiglightControl extends JPanel {
    ...
    public GraphViewDirectedNeighborHiglightControl(Graph g, String label) {
	...
	final GraphViewDirectedNeighborHiglightControl view = new GraphViewDirectedNeighborHiglightControl(
		g, label);
	...
	private GraphViewDirectedNeighborHiglightControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewDirectedNeighborHiglightControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewDirectedNeighborHiglightControl view) {
	    m_view = view;
