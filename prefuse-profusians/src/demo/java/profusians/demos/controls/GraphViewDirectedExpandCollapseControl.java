...
import profusians.controls.DirectedGraphExpandCollapseControl;
import profusians.controls.DirectedGraphNeighborHighlightControl;

/**
 * 
 * This program demonstrates the usage of the class
 * ExpandCollapseControlForDirectedGraphs, an extension of the ControlAdapter
 * from the prefuse library The class implements an expand/collapse control for
 * directed graphs. A right mouse click collapses the subtree exclusively rooted
 * by the clicked node, a left mouse click expands (previous collapsed) subtrees
 * rooted by the clicked node.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */

public class GraphViewDirectedExpandCollapseControl extends JPanel {
    ...
    public GraphViewDirectedExpandCollapseControl(Graph g, String label) {
	...
	DirectedGraphNeighborHighlightControl nhc = new DirectedGraphNeighborHighlightControl(
		new int[] { ColorLib.rgb(0, 0, 250), ColorLib.rgb(0, 250, 0),
	...
	fill.add(VisualItem.HIGHLIGHT, nhc.getHighlightColorAction());
	...
	animate.add(new MagicForceDirectedLayout(graph));
	animate.add(fill);
	...
	display.addControlListener(nhc);
	display
		.addControlListener(new DirectedGraphExpandCollapseControl(
			false));
	...
	final GraphViewDirectedExpandCollapseControl view = new GraphViewDirectedExpandCollapseControl(
		g, label);
	...
	private GraphViewDirectedExpandCollapseControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewDirectedExpandCollapseControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewDirectedExpandCollapseControl view) {
	    m_view = view;
