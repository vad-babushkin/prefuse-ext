...
/**
 * This program demonstrates the usage of the CenterOnClickControl, an extension
 * of the ControlAdapter from the prefuse library, which moves an clicked item
 * to the center of the display.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */
public class GraphViewCenterOnClick extends JPanel {
    ...
    public GraphViewCenterOnClick(Graph g, String label) {
	...
	display.addControlListener(new CenterOnClickControl(1000));
	...
	final GraphViewCenterOnClick view = new GraphViewCenterOnClick(g, label);
	...
	private GraphViewCenterOnClick m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewCenterOnClick view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewCenterOnClick view) {
	    m_view = view;
