package profusians.demos.controls;
...
/**
 * This program demonstrates the usage of the ExtendedNeighborHighlightControl
 * class, an extensions of the ControlAdapter class from the prefuse library.
 * This control highlights source neighbors, target neighbors and neighbors
 * which are both in user defined colors. For this control neighbor are defined
 * as all nodes within a given distance.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */

public class GraphViewExtendedNeighborHighlightControl extends JPanel {
    ...
    public GraphViewExtendedNeighborHighlightControl(Graph g, String label) {
	...
	LabelRenderer tr = new MyLabelRenderer();
	...
	final ExtendedNeighborHighlightControl enhc = new ExtendedNeighborHighlightControl(
		6, ColorLib.rgb(0, 100, 0), ColorLib.rgb(200, 250, 200));

	// final ExtendedNeighborHighlightControl enhc = new
        // ExtendedNeighborHighlightControl(3,new int[]
        // {ColorLib.rgb(0,100,0),ColorLib.rgb(200,250,200)});
	...
	fill.add(VisualItem.HIGHLIGHT, enhc.getHighlightColorAction());
	...
	// MAD
	final JValueSlider hslider = new JValueSlider("Highlight distance", 0,
		7, enhc.getDistance());
	...
	/*
         * Edge ess = g.getEdge(1); m_vis.getVisualItem(edges,
	...
	final GraphViewExtendedNeighborHighlightControl view = new GraphViewExtendedNeighborHighlightControl(
		g, label);
	...
	JFrame frame = new JFrame(
		"p r o f u s e | extended neighbor highlight control");
	...
	private GraphViewExtendedNeighborHighlightControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewExtendedNeighborHighlightControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewExtendedNeighborHighlightControl view) {
	    m_view = view;
