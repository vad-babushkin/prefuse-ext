...
import profusians.controls.BoundedDragControl;

/**
 * Modification of the original graph view demo from the prefuse library In this
 * demo, an additional BoundedDragControl is added to the display, which
 * restircts dragging of items to the bounds of the display.
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 */
public class GraphViewBoundedDragging extends JPanel {
    ...
    public GraphViewBoundedDragging(Graph g, String label) {
	...
	display.addControlListener(new BoundedDragControl(fdl));
	...
	final GraphViewBoundedDragging view = new GraphViewBoundedDragging(g,
		label);
	...
	private GraphViewBoundedDragging m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewBoundedDragging view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewBoundedDragging view) {
	    m_view = view;
