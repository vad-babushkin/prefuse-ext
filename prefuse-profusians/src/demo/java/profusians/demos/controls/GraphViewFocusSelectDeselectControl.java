...
import profusians.controls.FocusSelectDeselectControl;

/**
 * GraphView demo which enables focus deselect when a click on the display
 * background occurs
 * 
 ...
 * 
 */
public class GraphViewFocusSelectDeselectControl extends JPanel {
    ...
    public GraphViewFocusSelectDeselectControl(Graph g, String label) {
	...
	display.addControlListener(new FocusSelectDeselectControl());
	...
	final GraphViewFocusSelectDeselectControl view = new GraphViewFocusSelectDeselectControl(
		g, label);
	...
	private GraphViewFocusSelectDeselectControl m_view;

	public GraphMenuAction(String name, String accel,
		GraphViewFocusSelectDeselectControl view) {
	    m_view = view;
	...
	public OpenGraphAction(GraphViewFocusSelectDeselectControl view) {
	    m_view = view;
