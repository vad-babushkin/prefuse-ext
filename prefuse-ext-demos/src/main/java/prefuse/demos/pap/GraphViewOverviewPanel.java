 ...
 */
public class GraphViewOverviewPanel extends JPanel {
    ...
    public GraphViewOverviewPanel(Graph g, String label) {
    ...
    public static JFrame demo(Graph g, String label) {
        final GraphViewOverviewPanel view = new GraphViewOverviewPanel(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private GraphViewOverviewPanel m_view;
        public GraphMenuAction(String name, String accel, GraphViewOverviewPanel view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(GraphViewOverviewPanel view) {
            m_view = view;
