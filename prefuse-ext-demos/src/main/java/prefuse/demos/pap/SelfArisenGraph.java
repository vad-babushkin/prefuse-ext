...
public class SelfArisenGraph extends Display {
    ...
    public static JFrame demo() {
        SelfArisenGraph sag = new SelfArisenGraph();
        JFrame frame = new JFrame("adding data \"manually\" to a graph");
