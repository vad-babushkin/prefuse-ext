...
public class GraphViewDynamic extends Display {
	...
	LaterInsight ls = new LaterInsight(g,m_vis,this,GRAPH);
	...
	GraphViewDynamic sag = new GraphViewDynamic();
...
class LaterInsight {
    ...
    public LaterInsight(Graph data, Visualization vis, Display dis,String groupName) {
