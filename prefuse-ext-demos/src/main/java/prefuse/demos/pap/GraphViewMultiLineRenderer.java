...
/**
 * The original prefuse graph view demo with a very simple multiline renderer 
 * Needs the file socialnet.xml
 */
public class GraphViewMultiLineRenderer extends JPanel {
    ...
    public GraphViewMultiLineRenderer(Graph g, String label) {
...
//        opanel.add(overview);
    ...
    public static JFrame demo(Graph g, String label) {
        final GraphViewMultiLineRenderer view = new GraphViewMultiLineRenderer(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private GraphViewMultiLineRenderer m_view;
        public GraphMenuAction(String name, String accel, GraphViewMultiLineRenderer view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(GraphViewMultiLineRenderer view) {
            m_view = view;
