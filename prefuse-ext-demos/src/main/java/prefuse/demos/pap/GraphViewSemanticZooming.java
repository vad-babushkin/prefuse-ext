 ...
 * @author goose
 */
public class GraphViewSemanticZooming extends JPanel {
    ...
    public GraphViewSemanticZooming(Graph g, String label) {
...
//        opanel.add(overview);
    ...
    public static JFrame demo(Graph g, String label) {
        final GraphViewSemanticZooming view = new GraphViewSemanticZooming(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private GraphViewSemanticZooming m_view;
        public GraphMenuAction(String name, String accel, GraphViewSemanticZooming view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(GraphViewSemanticZooming view) {
            m_view = view;
