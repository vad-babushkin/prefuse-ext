 ...
 * Added the class FlexibleRadialTreeLayout, which enables the user to 
 * scale the x and y dimension of the the radial tree.
 * This is used to "react" on resizing of the window in order to fit the tree
 * "nicely" into the given space.
 * Just a view lines had to be added to the original example by Jeffrey, look out
 * for commentaries starting with MAD (most amazing discovery) to find them.
 * For sure it can be done more clever, nevertheless it seems to work.
 *
 */


public class FlexibleRadialGraphView2 extends Display {
    ...
    private FlexibleRadialTreeLayout treeLayout; //MAD - treeLayout moved up here
    
    public FlexibleRadialGraphView2(Graph g, String label) {
	...
	final FlexibleRadialGraphView2 gview = new FlexibleRadialGraphView2(g, label);
    ...
    /**
     * The class FlexibleTreeLayout, which overwrites the mehtod setPolarLoaction of the
     * the extended RadialTreeLayout in order to become flexible ...
     * 
     * @author goose
     *
     */
