...
/**
 * The graph view demo with an additional search panel
 * 
 * (look for MAD (most amazing discovery) to find the relevant additions to the 
 * orignal graph view demo)
 * 
 * @author <a href="http://jheer.org">jeffrey heer</a>
 * @author <a href="http://goosebumps4all.net">martin dudek</a>
 */
public class GraphViewSearchPanel extends JPanel {
    ...
    public GraphViewSearchPanel(Graph g, String label) {
	...
	m_vis.addFocusGroup(Visualization.SEARCH_ITEMS, search);
        ...
        fill.add("ingroup('_search_')", ColorLib.rgb(255,190,190)); //MAD
...
//        opanel.add(overview);
        ...
        //MAD - the search query binding and the searh panel
    ...
    public static JFrame demo(Graph g, String label) {
        final GraphViewSearchPanel view = new GraphViewSearchPanel(g, label);
    ...
    public abstract static class GraphMenuAction extends AbstractAction {
        private GraphViewSearchPanel m_view;
        public GraphMenuAction(String name, String accel, GraphViewSearchPanel view) {
            m_view = view;
    ...
    public static class OpenGraphAction extends AbstractAction {
        ...
        public OpenGraphAction(GraphViewSearchPanel view) {
            m_view = view;
