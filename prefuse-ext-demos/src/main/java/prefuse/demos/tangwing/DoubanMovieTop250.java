 ...
 *
 */
public class DoubanMovieTop250 extends JFrame{
	...
	public DoubanMovieTop250() {

		// -- 1. load the data ------------------------------------------------
		    	CSVTableReader csvReader = new CSVTableReader();
		    	Table t = null;
				try {
					InputStream is = new FileInputStream("data/tangwing/top250.csv");
					t = csvReader.readTable(is);
...
//		        		VisualItem.FILLCOLOR, new Integer(Constants.SHAPE_STAR));
		...
		// -- 4. the processing actions ---------------------------------------
		        ...
		        //ActionList layout = getLayoutActionList(LayoutType.RADIAL, true);
		...
		// -- 5. the display and interactive controls -------------------------
		        ...
		        //d.addControlListener(new HoverActionControl());
		        d.addControlListener(new ToolTipControl("title"));
		    
		// -- 6. launch the visualization -------------------------------------
		        
		        // create a new window to hold the visualization
		        this.setTitle("�����ӰTOP250");
	...
	private static ActionList getLayoutActionList(LayoutType lt, boolean repaintAction) {
        ...
        switch(lt)
        {
	        ...
	        case OTHER:
	        	...
	        	float gravConstant = -100f;  // the more negative, the more repelling
	        	float minDistance = 260f;	    // -1 for always on, the more positive, the more space between nodes
