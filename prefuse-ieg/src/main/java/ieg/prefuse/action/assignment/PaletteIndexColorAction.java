...
public class PaletteIndexColorAction extends ColorAction {
	...
	/**
	 * @param group             the aggregate group, e.g. GROUP_AGGREGATES
	 * @param paletteIndexField the data column where the colorIndex is stored, e.g.
	 *                          COL_COLOR_INDEX
	 * @param palette           the color palette use for coloring, e.g.
	 ...
	 * @param paletteIndexField the data column where the colorIndex is stored, e.g.
	 *                          COL_COLOR_INDEX
	 * @param palette           the color palette, e.g.
	 *                          HorizonColorPalette.getColorPalette(...)
