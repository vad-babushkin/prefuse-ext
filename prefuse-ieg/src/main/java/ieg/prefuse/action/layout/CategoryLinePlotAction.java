...
public class CategoryLinePlotAction extends LinePlotAction {
	 ...
	 *
	 * @param group         the new visual table containing line segments
	 * @param source        the visual table containing points
	 * @param categoryField the field name by which lines are to be distinguished
	 */
