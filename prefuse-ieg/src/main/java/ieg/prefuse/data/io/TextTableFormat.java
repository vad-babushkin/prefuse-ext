...
public class TextTableFormat {
	 ...
	 *
	 * @param method         either CSV or RegEx delimited
	 * @param hasHeader      first line is header or data
	 * @param parseDates     parse temporal data or not
	 * @param delimiterRegex delimiter for RegEx method
	 */
